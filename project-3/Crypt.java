...
// =============================================================================
	...
	NiceList<Character> source = read();
	NiceList<Character> result = null;
     ...
     **/
    private static NiceList<Character> read () {

	// Prepare to read from stdin.
	InputStream in = System.in;
	NiceList<Character> l = Cipher.createList();
     ...
     **/
    private static void write (NiceList<Character> l) {
