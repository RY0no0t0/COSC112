...
// =============================================================================
	...
	_game   = game;
	_height = game.getRows()    * _boxSize;
	_width  = game.getColumns() * _boxSize;
    ...
    // =========================================================================
    public void display (Graphics g) throws OffTheGridException {
    ...
    public void paintComponent (Graphics g){
        ...
        try {
            ...
            Support.abort("OffTheGridException happened at GraphicInterface.java");
        }
        // display(g);
    ...
    private final static int _wait   = 250;
