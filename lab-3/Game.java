...
// =============================================================================
     ...
     *                         universe is taken.
     * @param uiType The type of user interface to create.
     * @param cellType The kind of cell to create.
     **/
    public Game (String initialStatePath, String uiType, String cellType) {
	...
	if (_userInterface == null) {
	    Support.abort("Game.Game(): Invalid UI type = " + uiType);
	}
